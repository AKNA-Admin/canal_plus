   ...
   />
      ...
      <form onSubmit={handleSubmit}>
        ...
        <div style={{ marginBottom: '15px' }}>
          ...
          <input type="text" maxLength="14" value={numDecodeur} onChange={(e) => setNumDecodeur(e.target.value)} required style={{ width: '100%', padding: '6px', marginTop: '5px', borderRadius: '4px', border: '1px solid #ccc' }} />
        </div>
